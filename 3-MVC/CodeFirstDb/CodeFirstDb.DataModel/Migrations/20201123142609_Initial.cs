        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsGround = table.Column<bool>(type: "bit", nullable: false),
                    Name = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_Coffee_Quantity_Nonnegative", "[Quantity] >= 0");
                    table.ForeignKey(
                        name: "FK_Coffees_Stores_StoreId",
                        column: x => x.StoreId,
