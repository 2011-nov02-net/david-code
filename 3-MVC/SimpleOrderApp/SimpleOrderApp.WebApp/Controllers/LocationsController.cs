...
namespace SimpleOrderApp.WebApp.Controllers
{
    public class LocationsController : Controller
    {
        ...
        public ActionResult Create([Bind("Name,Stock")] LocationViewModel location, IFormCollection collection)
        {
            try
            {
                Location loc = new Location(location.Name, location.Stock);
                _repository.Create(loc);
